...
class Config:
    ...
    encoder_pretrained_model_path = osp.join(cur_dir, 'pretrained_models/osx_vit_l.pth')
    ...
    def set_additional_args(self, **kwargs):
        ...
        if self.encoder_setting == 'osx_b':
            self.encoder_config_file = os.path.join(cfg.root_dir,
                                                    'main/transformer_utils/configs/osx/encoder/body_encoder_base.py')
            self.encoder_pretrained_model_path = '../pretrained_models/osx_vit_b.pth'
            self.feat_dim = 768
        elif self.encoder_setting == 'osx_l':
            self.encoder_config_file = os.path.join(cfg.root_dir,
                                                    'main/transformer_utils/configs/osx/encoder/body_encoder_large.py')
    ...
    def prepare_dirs(self, exp_name):
        ...
        copy_files = ['main/config.py', 'main/train.py', 'main/test.py', 'common/base.py',
                      ...
                      'data/dataset_osx.py', 'data/MSCOCO/MSCOCO.py', 'data/AGORA/AGORA.py']
