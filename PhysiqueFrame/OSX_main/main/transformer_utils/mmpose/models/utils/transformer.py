...
class PatchEmbed(BaseModule):
    ...
    Args:
        ...
        init_cfg (`pam_mmcv.ConfigDict`, optional): The Config for initialization.
            Default: None.
    """
...
class PatchMerging(BaseModule):
    ...
    Instead, we need to modify pretrained models_ for compatibility.
...
class Transformer(BaseModule):
    ...
    Args:
        encoder (`pam_mmcv.ConfigDict` | Dict): Config of
            TransformerEncoder. Defaults to None.
        decoder ((`pam_mmcv.ConfigDict` | Dict)): Config of
            TransformerDecoder. Defaults to None
        init_cfg (obj:`pam_mmcv.ConfigDict`): The Config for initialization.
            Defaults to None.
    """
