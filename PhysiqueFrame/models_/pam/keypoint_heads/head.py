...
from pam_mmcv.cnn import (Conv2d, Linear, xavier_init)
from pam_mmcv.cnn.bricks.transformer import build_positional_encoding
from pam_mmpose.core.evaluation import keypoint_pck_accuracy
from pam_mmpose.core.post_processing import transform_preds
from pam_mmpose.models import HEADS
from pam_mmpose.models.utils.ops import resize

from ..pam_utils import build_transformer
...
class PoseHead(nn.Module):
    ...
    def forward_iaa(self, x, feature_s, target_s, mask_s, skeleton):
        """"Forward function for a single feature level.
        ...
        outs_dec, _, out_points, _, query_embed = self.transformer(x,
                                                                   masks,
                                                                   support_keypoints,
                                                                   pos_embed,
                                                                   support_order_embedding,
        ...
        return outs_dec, _, _, query_embed.transpose(1, 0)
