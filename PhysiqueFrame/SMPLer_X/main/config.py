...
class Config:
    def get_config_fromfile(self, config_path):
        ...
        self.human_model_path = osp.join(self.root_dir, 'common', 'utils_smpler_x', 'human_model_files')

        ## add some paths to the system root dir
        sys.path.insert(0, osp.join(self.root_dir, 'common'))
        from utils_smpler_x.dir import add_pypath
    ...
    def prepare_dirs(self, exp_name):
        ...
        from utils_smpler_x.dir import make_folder
...
cfg = Config()
config_path = osp.join('./SMPLer_X/main/config', 'config_smpler_x_l32.py')
ckpt_path = osp.join('./SMPLer_X/pretrained_models', 'smpler_x_l32.pth.tar')
cfg.get_config_fromfile(config_path)
cfg.prepare_dirs('output/test')
